...
public class DocsXml {
    ...
    public func setup(_ dependency: ViewDependency) -> UIView {
        ...
        view.addSubview(
            ...
            view.textString = ResourcesStrings.documentation
        ...
        view.addSubview(
            ...
            view.textString = "It's dangerous to go alone, take these articles!"
            view.numberOfLines = 0
            applyColor(view, ResourcesColors.foreground) { c in
                view.textColor = c
            }
    ...
    public unowned var articles: UITableView!
